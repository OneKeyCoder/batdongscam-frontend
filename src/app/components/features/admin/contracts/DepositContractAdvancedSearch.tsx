...
import { DepositContractFilters } from '@/lib/api/services/contract.service';
...
const AsyncSelect = ({ label, value, onChange, fetchOptions, placeholder }: AsyncSelectProps) => {
    ...
    return (
        <div className="relative" ref={wrapperRef}>
            ...
            <div
                className="w-full border border-gray-300 rounded-lg px-3 py-2.5 bg-white flex items-center justify-between cursor-pointer hover:border-blue-400 transition-colors shadow-sm"
                ...
                <div className="absolute z-50 mt-1 w-full bg-white border border-gray-200 rounded-lg shadow-xl max-h-60 overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-100">
                    <div className="p-2 border-b border-gray-100 bg-gray-50">
                        <div className="relative">
                            ...
                            <input
                                type="text"
                                className="w-full pl-8 pr-2 py-1.5 text-sm bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-200"
...
interface SearchProps {
    onApply: (filters: DepositContractFilters) => void;
    onReset: () => void;
}

export default function DepositContractAdvancedSearch({ onApply, onReset }: SearchProps) {
    ...
    const handleApply = () => {
        const filters: DepositContractFilters = { page: 1, size: 10, search: '' };
        ...
        <div className="flex flex-col h-full">
            <div className="space-y-6 flex-1 overflow-y-auto pr-2 pb-4 custom-scrollbar">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    {/* Entities Group */}
                    <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-5 p-5 bg-blue-50/50 rounded-xl border border-blue-200">
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100 mt-2">
                ...
                <button
                    onClick={handleApply}
                    className="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-bold rounded-lg flex items-center gap-2 shadow-sm transition-colors"
                >
...
const SelectInput = ({ label, value, onChange, options }: any) => (
    <div>
        ...
        <div className="relative">
            <select
                className="w-full appearance-none border border-gray-300 rounded-lg px-3 py-2.5 bg-white text-sm focus:outline-none focus:border-blue-500 cursor-pointer hover:border-gray-400 transition-colors shadow-sm"
                value={value}
...
const DateInput = ({ value, onChange, placeholder }: any) => {
    ...
    return (
        <div
            className="relative w-full border border-gray-300 rounded-lg bg-white cursor-pointer hover:border-blue-500 transition-colors shadow-sm group"
