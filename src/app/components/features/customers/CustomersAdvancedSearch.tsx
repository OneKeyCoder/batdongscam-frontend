    ...
    <div className="flex flex-col h-full">
      <div className="space-y-4 flex-1 overflow-y-auto pr-2 pb-4 custom-scrollbar">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <RangeInput label="spending" fromPlaceholder="3.5B" />
            <RangeInput label="contracts" fromPlaceholder="3.5B" />
            <RangeInput label="properties bought" fromPlaceholder="3.5B" />
            <RangeInput label="properties rented" fromPlaceholder="3.5B" />
            <RangeInput label="properties invested" fromPlaceholder="3.5B" />
